...
# load json
e_commerce_data_path_json = "/home/ubuntu/Desktop/Github/data-engineering/data/data_subset.json"
...
e_commerce_csv_df['InvoiceDate'] = pd.to_datetime(
    e_commerce_csv_df['InvoiceDate'])
...
"""e_commerce_csv_df = e_commerce_csv_df.astype(
    {'InvoiceNo': 'str',
     'CustomerID': 'str'
     }
)""" 
...
e_commerce_pivoted.to_parquet('/home/ubuntu/Desktop/Github/data-engineering/data/e_commerce_pivoted.parquet.gzip',
                              compression='gzip')
# > None
...
read_parquet = pd.read_parquet(
    '/home/ubuntu/Desktop/Github/data-engineering/data/e_commerce_pivoted.parquet.gzip')
